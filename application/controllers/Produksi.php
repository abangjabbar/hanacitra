...
class Produksi extends CI_Controller
{
    ...
    public function daftarOrder()
    {
        ...
        $config['base_url'] = base_url('produksi/daftarOrder'); //site url
        $config['total_rows'] = $this->Produksi_model->countall($this->session->userdata('filter')); //total row
        ...
        $data['transaksi'] = $this->Produksi_model->getOrderList($config["per_page"], $data['page'], $this->session->userdata('filter'));
