            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <a href="<?php echo site_url('substances') ?>"><i class="fas fa-arrow-left"></i> Daftar Harga Substance</a>
                    </div>
                    <div class="card-body">

                        <form action="<?php echo site_url('substances/addSubstance') ?>" method="post" enctype="multipart/form-data" >
                            <div class="form-group">
                                <label for="jenis">Jenis Substance*</label>
                            ...
                            <div class="form-group">
                                <label for="jumlah">BF*</label>
                                <input class="form-control <?php echo form_error('bf') ? 'is-invalid':'' ?>"
                                 type="text" name="bf" min="0" placeholder="BF" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                <label for="tanggal">CBF*</label>
                                <input class="form-control <?php echo form_error('cbf') ? 'is-invalid':'' ?>"
                                 type="text" name="cbf" placeholder="CBF" />
                                <div class="invalid-feedback">
