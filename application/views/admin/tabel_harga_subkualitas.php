                ...
                <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <br>
						        <a href="<?php echo site_url('hargasubkualitas/add_data') ?>"><i class="fas fa-plus"></i> Add New</a>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td width="150">
                                            <?php echo $dt['id_harga_subkualitas']; ?>
                                        </td>
                                        <td>
                                            <?php echo $dt['harga']; ?>
                                        </td>
                                        <td>
                                            <?php echo $dt['id_subkualitas']; ?>
                                        </td>
                                        <td style="width: auto;margin: 0 auto;" align="ceter">
                                            <input class="buttonu" type="button" 
                                            onclick="location.href='<?php echo base_url()."index.php/hargasubkualitas/edit_data/".$dt['id_harga_subkualitas']; ?>';" value="Ubah" />
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                    </tbody>
