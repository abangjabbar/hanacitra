                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <h3 class="category"><a href="<?php echo site_url('substances/addSubstance') ?>">Tambah</a></h3>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <td width="250">
                                            <a href="<?php echo site_url('substances/edit/'.$substance->id_substance) ?>"
                                             class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                            <a onclick="deleteConfirm('<?php echo site_url('substances/delete/'.$substance->id_substance) ?>')"
