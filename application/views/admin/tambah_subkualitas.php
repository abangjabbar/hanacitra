            ...
            <?php if ($this->session->flashdata('success')): ?>
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php echo site_url('subkualitas2/addSubkualitas') ?>" method="post" enctype="multipart/form-data" >
                            
                            <div class="form-group">
                                <label for="jenis">ID Subkualitas</label>
                                <input class="form-control <?php echo form_error('id_subkualitas') ? 'is-invalid':'' ?>"
                                 type="text" name="id_subkualitas" placeholder="ID Subkualitas" />
                                <div class="invalid-feedback">
                                    <?php echo form_error('id_subkualitas') ?>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="jenis">Subkualitas</label>
                                <input class="form-control <?php echo form_error('subkualitas_nama') ? 'is-invalid':'' ?>"
                                 type="text" name="subkualitas_nama" placeholder="Subkualitas" />
                                <div class="invalid-feedback">
                                    <?php echo form_error('subkualitas_nama') ?>
                                </div>
                            </div>
