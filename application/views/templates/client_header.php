...
<head>
    ...
    <!-- Favicons -->
    <link rel="icon" href="<?= base_url('assets/'); ?>/arsha/img/favicon.png">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                    <img src="<?= base_url('assets/'); ?>arsha/img/hero-img.png" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
                        <img src="<?= base_url(); ?>assets/arsha/img/skills.png" class="img-fluid" alt="">
                    </div>
