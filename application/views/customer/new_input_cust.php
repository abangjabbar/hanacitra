                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo site_url('orders/addNewOrderCust') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo form_error('nomor_po') ? 'is-invalid' : '' ?>" type="text" name="nomor_po" placeholder="Nomor PO" />
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo form_error('jenis') ? 'is-invalid' : '' ?>" type="text" name="jenis" placeholder="Jenis" />
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo form_error('image') ? 'is-invalid' : '' ?>" type="file" name="image" placeholder="Image" />
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo form_error('spesifikasi') ? 'is-invalid' : '' ?>" type="text" name="spesifikasi" placeholder="Spesifikasi" />
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo form_error('dimensi') ? 'is-invalid' : '' ?>" type="text" name="dimensi" placeholder="Dimensi" />
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?php echo form_error('deskripsi') ? 'is-invalid' : '' ?>" name="deskripsi" placeholder="Deskripsi pesanan..."></textarea>
                            <div class="invalid-feedback">
