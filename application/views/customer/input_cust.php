            ...
            <?php if ($this->session->flashdata('success')): ?>
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('orders') ?>"><i class="fas fa-arrow-left"></i> Daftar Pesanan</a>
					</div>
					<div class="card-body">

						<form action="<?php echo site_url('orders/addOrderCust') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('jumlah') ? 'is-invalid':'' ?>"
								 type="text" name="jumlah" min="0" placeholder="Jumlah" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
                                <label for="deskripsi">Substance*</label>
