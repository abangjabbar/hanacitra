...
<body>
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-5">
                        <div class="top-header-content">
                            <p>Welcome to Hana Citrabuana Site!</p>
                        </div>
                    </div>
                    <div class="col-7">
    ...
    <div id="container">
        ...
        <div id="body">
            ...
            <div style="margin:2%;border-bottom:1px solid;">
               Nama Produk : <?php echo $r['nama_produk'] ?><br>
               Harga Produk : <?php echo $r['harga_produk'] ?><br>
               Deskripsi Produk : <?php echo $r['deskripsi'] ?><br>
               Foto Produk : <?php echo $r['foto_produk'] ?><br><br>
               <a href="<?php echo site_url('produk/add/'.$r['id_produk'])?>" style="padding:0 2%;background-color:#3366ff;color:#fff;border-radius:2px;">Add to cart</a><br>
            </div>
        <?php } ?>
        </div>
