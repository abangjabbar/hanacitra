                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                <h4 class="title">Data Pembayaran Pelanggan</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $pembayaran->harga_satuan ?>
                                        </td>
                                        <td>
                                            <?php echo $pembayaran->harga_total ?>
                                        </td>
                                        <td>
                                            <?php echo $pembayaran->ppn ?>
                                        </td>
                                        <td>
                                            <img src="<?php echo base_url('upload/order/'.$pembayaran->image ) ?>" width="64" />
                                        </td>
                                        <td>
