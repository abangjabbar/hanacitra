            ...
            <?php if ($this->session->flashdata('success')): ?>
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('orders/orderCust') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php echo site_url('orders/addNew') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('subctance') ? 'is-invalid':'' ?>"
								 type="text" name="substance" placeholder="Substance" />
								<div class="invalid-feedback">
