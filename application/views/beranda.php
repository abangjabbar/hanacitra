...
<main id="main">
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row content">
                <div class="col-lg-6">
                    <p>
                        Kami CV. Hana Citra Buana adalah perusahaan yang bergerak dibidang jasa cetak
                        dan pembuatan corrugated karton box untuk kemasan.
                    </p>
                    <ul>
                ...
                <div class="col-lg-6 pt-4 pt-lg-0">
                    <p>
                        Kami tidak membatasi order yang diberikan kepada kami dari yang sedikit (satu) sampai yang terbanyak.
                        Untuk beberapa tipe cetakan per hari bisa kami kerjakan cepat berdasarkan desain yang kami terima.
                    </p>
                    <a href="<?= site_url("auth"); ?>" class="btn-learn-more">Pesan Sekarang</a>
                </div>
            </div>
    ...
    <section id="team" class="team section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Tim</h2>
                <p>Berikut beberapa Tim dari CV HANA CITRA BUANA</p>
            </div>
